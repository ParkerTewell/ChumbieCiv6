...
-----------------------------------------------	
	...
	('en_US',	'LOC_LEADER_PT_PIPPY_NAME',  'Chumbie'	),
...
-----------------------------------------------	
	...
	('en_US',	'LOC_TRAIT_LEADER_MC_FEAR_NOT_EXPLORATION_DESCRIPTION',		'All units receive +3 Combat Strength when attacking. +50% Production towards cavalry units. Gain the Pang Pang Cataphract unique unit at Stirrups.'	),
