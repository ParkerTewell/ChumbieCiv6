...
-----------------------------------------------	
	...
	('en_US',	'LOC_LEADER_MC_PO_NGBE_NAME',  'Chumbie'	),
	
-----------------------------------------------
-- Leader Unique Ability
-----------------------------------------------	

	('en_US',	'LOC_TRAIT_LEADER_MC_FEAR_NOT_EXPLORATION_NAME',			'Chumbie Charge'	),
	('en_US',	'LOC_TRAIT_LEADER_MC_FEAR_NOT_EXPLORATION_DESCRIPTION',		'All units receive +3 Combat Strength when attacking. +50% Production towards cavalry units. Gain the Pang Pang Cataphract unique unit at Stirrups. Gain the tar pit unique improvement with Refining Technology.'	),
